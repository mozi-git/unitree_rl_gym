...
1. **l_hip_pitch_joint** (髋部俯仰)
   ...
   - 对应连杆: l_hip_roll_link
   - 质量: 0.78331 kg
   - 惯性矩: ixx=0.00126, iyy=0.00126, izz=0.00126

2. **l_hip_roll_joint** (髋部滚动)  
   - 位置: xyz="0 0.07 0"
   - 限制: [-0.45379, 2.618] rad
   - 对应连杆: l_hip_thigh_link
   - 质量: 0.24756 kg
   - 惯性矩: ixx=0.0003962, iyy=0.0003962, izz=0.0003962

3. **l_hip_thigh_joint** (髋部偏航)
   - 位置: xyz="0 0 -0.095"
   - 限制: [-0.7854, 0.7854] rad
   - 对应连杆: l_hip_calf_link
   - 质量: 1.6427 kg
   - 惯性矩: ixx=0.0060015, iyy=0.0060015, izz=0.0060015

4. **l_hip_calf_joint** (膝盖)
   - 位置: xyz="0 0.00375 -0.097"
   - 限制: [-1.5708, 2.0944] rad
   - 对应连杆: l_ankle_pitch_link
   - 质量: 0.056538 kg
   - 惯性矩: ixx=4.9E-06, iyy=4.9E-06, izz=4.9E-06

5. **l_ankle_pitch_joint** (踝部俯仰)
   - 位置: xyz="0 -0.00375 -0.19945"
   - 限制: [-0.90757, 0.7854] rad
   - 对应连杆: l_ankle_roll_link
   - 质量: 0.59911 kg
   - 惯性矩: ixx=0.0002441, iyy=0.0002441, izz=0.0002441
